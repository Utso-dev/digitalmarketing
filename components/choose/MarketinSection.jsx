    ...
    <section className="bg-bgSecondColor dark:bg-blackColor dark:text-whiteColor py-10 lg:pt-28 lg:bg-bgthirdColor items-center justify-center lg:p-10 px-2.5 lg:px-0">
      <div className=" lg:max-w-containers md:max-w-mdcontainers sm:max-w-smcontainers mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className=" col-span-1 lg:space-y-20">
          ...
          <h1 className="lg:text-[60px] text-center dark:text-whiteColor text-[28px] lg:leading-[70px] font-semibold lg:font-bold text-blackColor2  mt-2">
            KEYWORD, RESEARCH STRATEGY, SURVEY, & ANALYTICS
          </h1>
          <p className=" mb-6 text-blackColor2 text-lg  text-center dark:text-whiteColor lg:text-start font-semibold mt-4 lg:px-28">
          ...
          <div className="flex justify-center lg:justify-start  lg:mt-4">
            <button className="border text-sm font-bold dark:border-whiteColor border-blackColor2  px-2 py-1 rounded-full">
              GOOGLE
            </button>
            <button className="border dark:border-whiteColor border-blackColor2 text-sm font-bold  px-2 py-1 rounded-full">
              PINTEREST
            </button>
            <button className="border dark:border-whiteColor border-blackColor2 text-sm font-bold  px-2 py-1 rounded-full">
              INSTAGRAM
  ...
  return (
    ...
    >
      <div className="col-span-3">
        <div className="md:w-[174px] dark:border-whiteColor dark:bg-blackColor2 md:h-[174px] w-[130px]  h-[130px] flex items-center justify-center border-2 border-blackColor2 rounded-full text-4xl font-bold">
          {percentage}
        </div>
      </div>

      <div className=" col-span-5 pr-5">
        <h3 className="text-3xl font-bold dark:text-whiteColor text-blackColor2">
          {title}
        </h3>
        <p className="lg:text-textColor dark:text-whiteColor text-blackColor2 font-bold sm:font-semibold lg:font-medium text-lg mt-4">
          {description}
        </p>
      </div>
    </div>
