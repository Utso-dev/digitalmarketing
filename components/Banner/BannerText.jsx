    ...
    <div>
      <div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className=" text-[60px] dark:text-whiteColor sm:text-[100px] sm:leading-[100px] leading-10 uppercasetext-blackColor md:text-[110px] md:leading-[100px] lg:leading-[240px]  lg:text-[260px] font-extrabold lg:font-bold"
        >
          {" "}
          {name1.map((w, i) => (
            <motion.span
        ...
        <motion.h1
          ...
          transition={{ duration: 1.5, ease: "easeOut" }}
          viewport={{ once: true }}
          className=" sm:ml-[13rem] dark:text-whiteColor md:absolute leading-10 sm:leading-[100px] z-30  sm:text-[100px] lg:right-0 md:right-10 ml-[4.5rem] md:text-[110px]  md:leading-[100px] uppercase text-[60px] text-blackColor lg:leading-[240px] lg:text-[260px] font-extrabold  lg:font-bold"
        >
          {name2.map((w, i) => (
            <motion.span
              key={i}
